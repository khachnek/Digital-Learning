...
<body>
	<div class="jumbotron text-center">
		<h1>Your Learning path for project ${projectId} is as follows:</h1>
	</div>

	<c:forEach items="${learningPath}" var="path">
		<ol>
			<option value="${path.key}">${path.key}</option>
			<option value="${path.value}"><a
					href="<c:url value = "${path.value}"/>">${path.value}</a></option>
		</ol>
	</c:forEach>
