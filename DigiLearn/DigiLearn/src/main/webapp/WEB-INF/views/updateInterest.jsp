...
<title>Update your interest</title>
</head>
...
<body>
	...
	<div class="container ">
		<form action="/updateEmpInterest">



			<input class="form-control" type="text" placeholder="Employee Id "
				name="id"><br> <input class="form-control" type="text"
				placeholder="Employee Name " name="name"><br>
			<input class="form-control" type="text" placeholder="Interests separated by comma" name="interests"><br>

			<div class="form-row">
				<div class="col">
					<button type="submit" class="btn btn-primary btn-block">Update Interests</button>
				</div>
			</div>
